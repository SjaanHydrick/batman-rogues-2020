...
app.post('rogues/', async(req, res) => {
  try {
    ...
    const data = await client.query(`
    INSERT INTO rogues (alias, name, alive, category, year)
    VALUES ($1, $2, $3, $4, $5)
    RETURNING *
    `,
    [newAlias, newName, newAlive, newCategory, newYear]);
...
app.put('rogues/:id', async(req, res) => {
  try {
    ...
    RETURNING *
    `,
    [newAlias, newName, newAlive, newCategory, newYear, req.params.id]);
